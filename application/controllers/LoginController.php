...
public function registro()
  {
	...
	if(empty($user)){header("location: /queveo/login");}  // Si el array está vació quiere decir que el usuario o la contraseña son incorrectos 
	 elseif($user[0]["rol"]==2) {header("location: /queveo/usuario");} // si el usuario y contraseña son correctos nos envía a la ruta "usuario"
